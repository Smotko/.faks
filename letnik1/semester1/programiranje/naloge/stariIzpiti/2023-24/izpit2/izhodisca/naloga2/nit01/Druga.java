            ...
            for(int i = 0; i < tab.length; i++){
                ...
                for(int j = 0; j < tab[i].length; j++){
                    ...
                    if(smer[i][j] == 1){
                        ...
                        if(tab[i][j-1] == 0 && i != 0 && j != 1 && k < tab.length*tab[0].length - tab[0].length - tab.length - 100)
                            continue;
                        ...
                        if(tab[i-1][j] == 0 && i != 1 && j != 0 && k < tab.length*tab[0].length - tab.length - tab[0].length - 100)
                            continue;
                        ...
                        if(tab[i][j+1] == 0 && k < tab[0].length*tab[0].length - tab[0].length - tab.length - 100)
                            continue;
                        ...
                        if(tab[i+1][j] == 0 && k < tab.length*tab[0].length - tab.length - tab[0].length - 100)
                            continue;
