...
public class Test12 {
    ...
    public static void main(String[] args) {
		...
		System.out.println(os41.staVSorodu(os42));
		System.out.println(os42.staVSorodu(os41));
		System.out.println(os41.staVSorodu(os24));
		
		System.out.println(os41.staVSorodu(os43));
		System.out.println(os41.staVSorodu(os44));
		
		System.out.println(os22.staVSorodu(os25));		
		System.out.println(os34.staVSorodu(os45));
    }
}